module hp_library::ism_metadata {
    ...
    // Get merkle index from metadata bytes
    public fun merkle_index_u32(metadata_bytes: &vector<u8>): u32 {
        hacks::to_u32(
            utils::extract_from_bytes_reversed(
                metadata_bytes,
                MERKLE_INDEX_OFFSET,
                SIGNATURES_OFFSET
            )
    ...
    public fun signature_at(
        ...
        assert!(
            sigbytes_len % SIGNATURE_LENGTH == 0,
            ERROR_INVALID_BYTES_LENGTH
        );
